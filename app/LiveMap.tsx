...
export default function LiveMap({ coordinates, mapLayer, candidates, activeCandidate, onCandidateSelect, projectName, zoom, radius, drawMode, areaPoints, onAreaChange }: { coordinates: Coordinates; mapLayer: "street" | "satellite"; candidates: Candidate[]; activeCandidate: number; onCandidateSelect: (index: number) => void; projectName: string; zoom: number; radius: number; drawMode: boolean; areaPoints: Coordinates[]; onAreaChange: (points: Coordinates[]) => void }) {
